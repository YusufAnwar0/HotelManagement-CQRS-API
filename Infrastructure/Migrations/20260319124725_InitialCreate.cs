    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomTypeOffer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomTypeOffer_Offers_OfferId",
                        column: x => x.OfferId,
                        principalTable: "Offers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomTypeOffer_RoomTypes_RoomTypeId",
                        column: x => x.RoomTypeId,
                        principalTable: "RoomTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomReservations_Offers_OfferId",
                        column: x => x.OfferId,
                        principalTable: "Offers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_CheckInDate_CheckOutDate_Status",
                table: "Reservations",
                columns: new[] { "CheckInDate", "CheckOutDate", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomReservations_OfferId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomTypeFacilities_RoomTypeId_FacilityId",
                table: "RoomTypeFacilities",
                columns: new[] { "RoomTypeId", "FacilityId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RoomTypeOffer_OfferId",
                table: "RoomTypeOffer",
                column: "OfferId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomTypeOffer_RoomTypeId",
                table: "RoomTypeOffer",
                column: "RoomTypeId");
